...
class RunNAMETrajectory(Process):
    ...
    def __init__(self):
        ...
        inputs = [
            ...
            LiteralInput('TrajectoryHeights',
                         abstract='array of start/end heights of particles',
                         data_type='float',
                         min_occurs=1,
                         ),

            LiteralInput('TrajectoryHeightUnits',
            ...
            LiteralInput('NotificationEmail',
                         abstract='which email address to send notifications to',
                         data_type='string',
                         min_occurs=0,
                         max_occurs=1),

            LiteralInput('ImageFormat',
